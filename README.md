...
A reusable HTML template for publishing security notices for expired domains acquired by third parties.
...
This project is part of security research intended to raise awareness of the risks associated with expired domains acquired by third parties.
